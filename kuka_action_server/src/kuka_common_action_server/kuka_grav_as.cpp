...
Kuka_grav_as::Kuka_grav_as(ros::NodeHandle&  nh,const Action_j_initialiser &init):
     Base_j_action(nh,
...
bool Kuka_grav_as::execute_CB(alib_server& as_,alib_feedback& feedback_,const cptrGoal& goal){
    ...
    if (action_name == (goal->action_name))
    {
        ...
        ROS_INFO("current_stiffness: [%f,%f,%f,%f,%f,%f,%f]", j_stiffness[0],
                j_stiffness[1],j_stiffness[2],
                j_stiffness[3],j_stiffness[4],
                j_stiffness[5],j_stiffness[6]);

...
if("TRUE" STREQUAL "TRUE")
  set(kuka_action_server_SOURCE_PREFIX /home/guillaume/roscode/catkin_ws/src/kuka_planning_interface/kuka_action_server)
  set(kuka_action_server_DEVEL_PREFIX /home/guillaume/roscode/catkin_ws/src/kuka_planning_interface/kuka_action_server/build/devel)
...
if(NOT "/home/guillaume/roscode/catkin_ws/src/kuka_planning_interface/kuka_action_server/include " STREQUAL " ")
  set(kuka_action_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/guillaume/roscode/catkin_ws/src/kuka_planning_interface/kuka_action_server/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kuka_action_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/guillaume/roscode/catkin_ws/src/kuka_planning_interface/kuka_action_server/${idir}'.  Ask the maintainer 'guillaume <guillaume@todo.todo>' to fix it.")
    endif()
    _list_append_unique(kuka_action_server_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "kuka_action_server")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/guillaume/roscode/catkin_ws/src/kuka_planning_interface/kuka_action_server/build/devel/lib;/home/guillaume/roscode/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
set(kuka_action_server_EXPORTED_TARGETS "")
...
set(depends "std_tools;tf;mathlib")
